...
function Privacy(props: React.PropsWithoutRef<PrivacyProps>): JSX.Element {
  return (
    <>
      <Head>
        <title>Terms and Conditions — Pleasantcord</title>
      ...
      >
        ...
        <main className="flex-1 my-16 px-6 mx-auto">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Pleasantcord.
                </p>
              </li>
              <li>
                <p>
